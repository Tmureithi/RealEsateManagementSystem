...
function cap()
{
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" name="fname" class="form-control" onkeydown = "cap()"  id="inputFname" placeholder="First Name" pattern="[A-Za-z]+" required/>
      </div>
     </div>
...
function cap1()
{
    ...
    document.getElementById("inputmiddlename").value = str.charAt(0).toUpperCase() + str.slice(1);
      ...
      <div class="controls">
        <input type="text" name="middlename" onkeydown="cap1()"   id="inputmiddlename" placeholder="Middle Name" pattern="[A-Za-z]+" required/>
      </div>
...
function cap2()
{
    ...
    document.getElementById("inputLname").value = str.charAt(0).toUpperCase() + str.slice(1);
     ...
     <div class="control-group">
      ...
      <div class="controls">
        <input type="text" name="lastname" onkeydown="cap2()" id="inputLname" placeholder="Last Name" pattern="[A-Za-z]+" required/>
      </div>
     </div>
         <!---------------------------------------------->
    ...
    <div class="controls">
      <input type="text" name="email" id="inputEmail" placeholder="Email" pattern=".+@jdl.com" size="30" required/>
    </div>
    </div>
...
function cap3()
{
    ...
    <div class="control-group">
      <label class="control-label" for="city">County *</label>
      <div class="controls">
...
=
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text"  name="cnumber" id="phone" placeholder="phone"  pattern="[0-9]{3}[0-9]{3}[0-9]{3}" required/>
      </div>
    </div>
