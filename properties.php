...
<div class="navbar navbar-fixed-top">
            ...
            <li class="active"><a href="products.php"><i class=" icon-th-large icon-large"></i> Properties</a></li>
            <li><a href="contact.php"><i class="icon-signal"></i> Contact Us</a></li>
            <li><a href="aboutus.php"><i class="icon-flag"></i>  About Us</a></li>
             <li><a href="server/index.php"><i class="icon-user"></i> CPANEL  </a></li>
					</ul>
...
<!-- ==================================================Header End====================================================================== -->
  ...
  <h3><font color="white"> Properties </h3> 
...
?>
        ...
        <div class="caption">
          ...
          <h4><a class="btn-success btn" title="Click to view!" href="property_details.php? id=<?php echo $id;?>"><i class="icon-check"></i> VIEW</a> <span class="pull-right">Price:KES   <?php echo formatMoney($row['price'],2); ?></span></h4>
        </div>
        </div>
      </li>
         <?php } ?>
