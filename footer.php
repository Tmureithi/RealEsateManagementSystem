...
The company is located at  &nbsp; &nbsp; 1 Ololua lane  &nbsp;&nbsp; &nbsp; Ngong town

		 </div>

		 <div class="span3">
			<h5>Email Address:</h5>   salesjd@jdlkenya.com<br/>
			<p>   Website: http://jerseydevelopers.com/  Contact No: 0707773151</p>
		 </div></font>
	 ...
	 <hr class="soft">
	<p class=""><marquee><font color="black">&copy; Jersey Developers Ltd. <?php echo date("Y")?></font></marquee></p>
