...
<br /><br />
    ...
    <li><a href="user_properties.php">Property</a> <span class="divider">/</span></li>
    <li class="active">Property Details</li>
    </ul> 
  <div class="row">  
  <?php 
$id=$_GET['id'];
$query2=mysql_query("select * from tb_properties where propertyID='$id'") or die (mysql_error());
...
<font color="white">
      <div id="gallery" class="span3">
        ...
        <?php
                         ...
                         mysql_query("insert into payment_details
                          (Paymentdetailsid,PropertyID,Unit,Total,CustomerID) values
        ...
        <form class="form-horizontal qtyFrm" method="post">
          <input type="hidden" id="username" name="id" value="<?php
             $id = mysql_query("select MAX(Paymentdetailsid) as max_Paymentdetailsid from payment_details");                                       
           $row = mysql_fetch_array($id);
             echo $row['max_Paymentdetailsid'] + 1;                                       
                        ?>" class="input-xlarge" required/>
          <div class="control-group">
          <label><h3><span>&nbsp;&nbsp;&nbsp;Price: KES<?php echo formatMoney($row2['price'],2);?></span></h3></label>
			
             <?php 
   $count_query = mysql_query("select * from payment_details where customerID='$ses_id' and PropertyID='$pid' and PaymentID=''") or die(mysql_error());
...
?>
    <br />
    <h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $qty;?> Unit(s) Available</h4> 
       <input type="hidden" id='qleft' value="<?php echo $qty;?>">
       
       <button type="submit" name="submit" class="btn btn-large pull-right"><i class=" icon-shopping-cart"></i> Proceed </button>
    <?php }
     }
     else{
       ?>
       <span style="color:red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PROPERTY(S) SAVED</span>
<?php
     }
   ?>
