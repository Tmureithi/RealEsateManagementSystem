...
<?php 
$get_id=$_GET['id'];
$query3=mysql_query("select * from payment_details where paymentdetailsid='$get_id'") or die (mysql_error());
...
<?php
                         ...
                         mysql_query("update payment_details set
                          Unit='$qty',Total='$tos' where Paymentdetailsid='$id'") 
                     or die(mysql_error());
                                            ?>
...
<form method="post">
  ...
  <table class="table table-bordered">
              ...
              <tbody>
                <?php 
                       $id = $_GET['id'];
$query=mysql_query("select * from payment_details where Paymentdetailsid='$id'") or die (mysql_error());
$row=mysql_fetch_array($query);
